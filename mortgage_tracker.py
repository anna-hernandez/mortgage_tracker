...
for year in range(mortgage_length):
    ...
    print('Year {}: {} to pay, {} on interests, {} on capital. Left to pay: {}'.format(year+1, round(annual_repayment,2), round(on_interests,2), round(on_capital,2), round(working_borrowed,2)))
...
# add legend and labels, adjust y axis limits
